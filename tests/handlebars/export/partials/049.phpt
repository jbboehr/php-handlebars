--TEST--
partials - inline partials - should render nested inline partials
--DESCRIPTION--
partials - inline partials - should render nested inline partials
--SKIPIF--
<?php
...
$tmpl = '{{#*inline "outer"}}{{#>inner}}<outer-block>{{>@partial-block}}</outer-block>{{/inner}}{{/inline}}{{#*inline "inner"}}<inner>{{>@partial-block}}</inner>{{/inline}}{{#>outer}}{{value}}{{/outer}}';
